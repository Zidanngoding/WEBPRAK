...
<footer class="bg-[#4169e1] text-white py-6 mt-10">
  <div class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
    <div>
      <h4 class="font-semibold text-lg mb-2">ABOUT MoneyTracker</h4>
      <p class="text-sm">Aplikasi pencatat keuangan pribadi untuk mengelola pemasukan dan pengeluaran harianmu.</p>
    </div>
    <div>
